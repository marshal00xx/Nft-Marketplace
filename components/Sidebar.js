  ...
  return (
    <div className={styles.container}>
      <div className={styles.profile}>
        {
          // && means if the user is authenticated it will loads the div 
          isAuthenticated && (
            <>
      ...
      <div className={styles.menu}>
        {/* the backslash in href means that whenever we click the link it will redirect us to the home page */}
        <Link href='/'>
